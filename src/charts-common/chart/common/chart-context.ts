...
export abstract class ChartContext {
  ...
  abstract requestAnimation(transition): void;

  abstract requestPaint(): void;

  abstract enableA11yExploreMode(List<A11yNode> nodes, {String announcement}): void;

  abstract disableA11yExploreMode({String announcement}): void;
}
